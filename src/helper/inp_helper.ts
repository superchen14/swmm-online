...
function parsePollutant(line: string): Pollutant {
  ...
  const iiConcentration = Number.parseFloat(items[4]);
  return createPollutant(pollutantName, unit, rainWaterConcentration, groundWaterConcentration, iiConcentration);
}
