...
function createSubcatchment(name: string, vertices: Point[], outletNode: Node, area: number, width: number): Subcatchment {
  ...
  return {name, vertices, position, outletNode, area, width};
}
